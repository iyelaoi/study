...
public class Main6 implements Runnable{
    ...
    public static void main(String[] args){
        ...
        solve();
        sharding();
        Main6[] main6s = new Main6[THREAD_COUNT];
        for (int i = 0; i < THREAD_COUNT; i++){
            main6s[i] = new Main6(i);
            new Thread(main6s[i]).start();
        }
        try {
        ...
        out("/projects/student/result.txt", main6s);
    }
    ...
    static void out(String name, Main6[] main6s){
        ...
        try{
            ...
            for (int i = 0; i < 5; i++) {
                for (Main6 main6 : main6s){
                    List<Integer[]> linkedLists = main6.result[i];
