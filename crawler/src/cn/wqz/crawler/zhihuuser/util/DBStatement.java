package cn.wqz.crawler.zhihuuser.util;
...
public class DBStatement {
    ...
    private DBStatement(){
        try {
             ...
             * 4.password:123
             */
            Class.forName("com.mysql.cj.jdbc.Driver");//加载驱动类(注册驱动类)
            String mySqlUrl = "jdbc:mysql://localhost:3306/spider?useSSL=false&serverTimezone=UTC&CharacterEncoding=utf-8";
            String username = "root";
            String password = "461299";
